 ...
 * @author frwang
 */
public class CandleStickChartSample extends XYChart<Number, Number> {

    // -------------- CONSTRUCTORS ----------------------------------------------
    /**
     * Construct a new CandleStickChartSample with the given axis.
     *
     * @param xAxis The x axis to use
     * @param yAxis The y axis to use
     */
    public CandleStickChartSample(Axis<Number> xAxis, Axis<Number> yAxis) {
        super(xAxis, yAxis);
        setAnimated(false);
    ...
    /**
     * Construct a new CandleStickChartSample with the given axis and data.
     *
     * @param xAxis The x axis to use
     * @param yAxis The y axis to use
     ...
     */
    public CandleStickChartSample(Axis<Number> xAxis, Axis<Number> yAxis, ObservableList<Series<Number, Number>> data) {
        this(xAxis, yAxis);
        setData(data);
    }
